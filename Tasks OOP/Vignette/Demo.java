...
import mainPackage.GasStation;
import mainPackage.Vehicle;

public class Demo {

//	Реализирайте структура от класове, която да описва система за закупуване и
...
//	ред. -5т.
	...
	public static void main(String[] args) {
		...
		GasStation gasStation = new GasStation(2000);
		Driver d1 = new Driver("Driver1",1000); 
		Driver d2 = new Driver("Driver2",1000); 
		Driver d3 = new Driver("Driver3",1000); 
		Driver d4 = new Driver("Driver4",1000); 
		Driver d5 = new Driver("Driver5",1000); 
		d1.setGasStation(gasStation);
		d2.setGasStation(gasStation);
		d3.setGasStation(gasStation);
		d4.setGasStation(gasStation);
		d5.setGasStation(gasStation);
		
		gasStation.showVignettes();
		
		d1.addVehicle(new Vehicle("BMW", TypeVehicleAndVignette.CAR,new Date()));
		d1.addVehicle(new Vehicle("Opel", TypeVehicleAndVignette.CAR,new Date()));
		d1.addVehicle(new Vehicle("Opel2", TypeVehicleAndVignette.CAR,new Date()));
		System.out.println("Quantity vignettes:"+gasStation.getQuantityOfVignettes());
		d1.buyVignette(1, TypeVignetteAccordingToValidityTerm.MONTHLY);
		d1.buyVignette(2, TypeVignetteAccordingToValidityTerm.ANNUAL);
		d1.buyVignette(3, TypeVignetteAccordingToValidityTerm.DAY);
		
		d1.showMoney();
		gasStation.showMoney();
		d1.showVehicles();
		gasStation.showVignettes();
		Date date = new Date();
